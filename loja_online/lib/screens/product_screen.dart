            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  maxLines:
                      3, //define o maximo de linhas que posso ter nesse textstyle
                ),
                Text(
                ...
                SizedBox(
                  ...
                  child: GridView(
                      ...
                      scrollDirection: Axis
                          .horizontal, //caso nao adicione, ficará na vertical
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: s == size
                                      ? primaryColor
                                      : Colors.grey[
                                          500], //se 's' é igual a size (cor selecionada), se nao = cinza..
                                  width: 3.0),
                            ),
                            width: 50.0,
                ...
                SizedBox(
                  height: 44.0,
                  child: RaisedButton(
                    //botão so ativa caso clique em algum dos tamanhos
                    onPressed: size != null
                        ? () {
